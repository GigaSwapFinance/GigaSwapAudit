...
abstract contract MaxWalletDynamic {
    ...
    uint256 constant maxBuyIncrementPercentil = 3; // increment maxbyu percent 1000=100%
    uint256 constant maxIncrements = 1000; // maximum time increments
...
abstract contract TradableErc20 is ERC20, DoubleSwapped, Ownable, Withdrawable {
    ...
    function SetExtraContractAddress(
        address newExtraContractAddress
    ) external onlyWithdrawer {
